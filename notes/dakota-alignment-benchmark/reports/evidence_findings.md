...
3. **The old script is internally reproducible.** Rerunning it produces parsed JSON identical to the stored result; insignificant formatting differs. That proves software repeatability only; its data mapping and illustrative error model remain disputed.
